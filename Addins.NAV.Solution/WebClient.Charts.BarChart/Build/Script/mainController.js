...
angular.module("GlobalModule").controller("chartsController", chartsController);
chartsController.$inject = ['$scope', '$timeout'];

function chartsController($scope, $timeout) {

    $scope.initLSxChartConfig = {
        func: function (chart) {
            $timeout(function () {
                chart.reflow();
            }, 0);
        ...
        events: {
            load: function () {
                var chart = this;
                $timeout(function () { chart.reflow(); }, 0);
            }
        },
        title: {
            text: 'LSx 4.y'
    ...
    $scope.initAllPlatformsYTDChartConfig = {
        func: function (chart) {
            $timeout(function () {
                chart.reflow();
            }, 0);
